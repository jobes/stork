...
class AltitudeDetailsDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AltitudeDetailsDialog> createState() => _AltitudeDetailsDialogState();
}
...
class _AltitudeDetailsDialogState extends ConsumerState<AltitudeDetailsDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<double?>(
      appSettingsProvider.select((s) => s.value?.qnh),
      (previous, next) {
                          ...
                          children: [
                            ...
                            Switch(
                              ...
                              onChanged: (bool value) {
                                ref.read(appSettingsProvider.notifier).updateAutoQnh(value);
                              },
