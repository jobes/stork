...
mixin _$AppSettings {
 ...
 RangeThresholds get chtThresholds; double get chtMaxRange;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double mapFontSize,  double mapDefaultZoom,  double mapOverviewZoom,  double mapFollowZoom,  RangeThresholds flightSpeedThresholds,  double flightSpeedMaxRange,  int courseLineSegmentsCount,  int courseLineSegmentDuration,  bool autoSelectDevice,  CannelloniDevice? selectedDevice,  bool areWidgetsDraggable,  Map<String, WidgetPosition> widgetPositions,  SpeedUnit speedUnit,  double qnh,  double qfe,  bool autoQnh,  AltitudeUnit altitudeUnit,  AltitudeUnit heightUnit,  double averageSpeed,  String? pilotId,  String? airplaneId,  TemperatureUnit temperatureUnit,  RangeThresholds oilTempThresholds,  double oilTempMaxRange,  PressureUnit pressureUnit,  RangeThresholds oilPressureThresholds,  double oilPressureMaxRange,  RangeThresholds fuelThresholds,  RangeThresholds egtThresholds,  double egtMaxRange,  RangeThresholds chtThresholds,  double chtMaxRange)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppSettings() when $default != null:
return $default(_that.mapFontSize,_that.mapDefaultZoom,_that.mapOverviewZoom,_that.mapFollowZoom,_that.flightSpeedThresholds,_that.flightSpeedMaxRange,_that.courseLineSegmentsCount,_that.courseLineSegmentDuration,_that.autoSelectDevice,_that.selectedDevice,_that.areWidgetsDraggable,_that.widgetPositions,_that.speedUnit,_that.qnh,_that.qfe,_that.autoQnh,_that.altitudeUnit,_that.heightUnit,_that.averageSpeed,_that.pilotId,_that.airplaneId,_that.temperatureUnit,_that.oilTempThresholds,_that.oilTempMaxRange,_that.pressureUnit,_that.oilPressureThresholds,_that.oilPressureMaxRange,_that.fuelThresholds,_that.egtThresholds,_that.egtMaxRange,_that.chtThresholds,_that.chtMaxRange);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double mapFontSize,  double mapDefaultZoom,  double mapOverviewZoom,  double mapFollowZoom,  RangeThresholds flightSpeedThresholds,  double flightSpeedMaxRange,  int courseLineSegmentsCount,  int courseLineSegmentDuration,  bool autoSelectDevice,  CannelloniDevice? selectedDevice,  bool areWidgetsDraggable,  Map<String, WidgetPosition> widgetPositions,  SpeedUnit speedUnit,  double qnh,  double qfe,  bool autoQnh,  AltitudeUnit altitudeUnit,  AltitudeUnit heightUnit,  double averageSpeed,  String? pilotId,  String? airplaneId,  TemperatureUnit temperatureUnit,  RangeThresholds oilTempThresholds,  double oilTempMaxRange,  PressureUnit pressureUnit,  RangeThresholds oilPressureThresholds,  double oilPressureMaxRange,  RangeThresholds fuelThresholds,  RangeThresholds egtThresholds,  double egtMaxRange,  RangeThresholds chtThresholds,  double chtMaxRange)  $default,) {final _that = this;
switch (_that) {
case _AppSettings():
return $default(_that.mapFontSize,_that.mapDefaultZoom,_that.mapOverviewZoom,_that.mapFollowZoom,_that.flightSpeedThresholds,_that.flightSpeedMaxRange,_that.courseLineSegmentsCount,_that.courseLineSegmentDuration,_that.autoSelectDevice,_that.selectedDevice,_that.areWidgetsDraggable,_that.widgetPositions,_that.speedUnit,_that.qnh,_that.qfe,_that.autoQnh,_that.altitudeUnit,_that.heightUnit,_that.averageSpeed,_that.pilotId,_that.airplaneId,_that.temperatureUnit,_that.oilTempThresholds,_that.oilTempMaxRange,_that.pressureUnit,_that.oilPressureThresholds,_that.oilPressureMaxRange,_that.fuelThresholds,_that.egtThresholds,_that.egtMaxRange,_that.chtThresholds,_that.chtMaxRange);case _:
  throw StateError('Unexpected subclass');
...
@override $RangeThresholdsCopyWith<$Res> get flightSpeedThresholds;@override $CannelloniDeviceCopyWith<$Res>? get selectedDevice;@override $RangeThresholdsCopyWith<$Res> get oilTempThresholds;@override $RangeThresholdsCopyWith<$Res> get oilPressureThresholds;@override $RangeThresholdsCopyWith<$Res> get fuelThresholds;@override $RangeThresholdsCopyWith<$Res> get egtThresholds;@override $RangeThresholdsCopyWith<$Res> get chtThresholds;
