class CanonicalId {
  ...
  static String normalize(String rawId) {
    ...
    trimmed = trimmed.replaceAll(RegExp(r'^(ICAO|FLR|OGN):', caseSensitive: false), '');

    // Remove prefixes like ICA, FLR, OGN if directly concatenated before 6-digit hex
    trimmed = trimmed.replaceAll(RegExp(r'^(ICAO|ICA|FLR|OGN)(?=[0-9A-Fa-f]{6}$)', caseSensitive: false), '');
