...
class CylinderTempTelemetryWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Rotax 912 UL default CHT thresholds in Kelvin
    final thresholds = const RangeThresholds.raw(
    ...
    final double maxVisualK = 433.15; // 160 °C
    final double minVisualK = 323.15; // 50 °C
