...
void main() {
  ...
  group('OgnAprsService Tests', () {
    ...
    test('parseAprsLine parses standard glider packet correctly', () {
      const packet = 'FLR1EFCCC>OGFLR,qAS,K2B9:/172500h4432.07N/07306.44W^000/000/A=000646 !W72! id061EFCCC +039fpm -2.1rot 28.0dB';
    ...
    test('parseAprsLine respects stealth privacy flag', () {
      ...
      const packet = 'FLR1EFCCC>OGFLR,qAS,K2B9:/172500h4432.07N/07306.44W^000/000/A=000646 !W72! id861EFCCC +039fpm';
    ...
    test('parseAprsLine respects no-tracking privacy flag', () {
      ...
      const packet = 'FLR1EFCCC>OGFLR,qAS,K2B9:/172500h4432.07N/07306.44W^000/000/A=000646 !W72! id461EFCCC +039fpm';
    ...
    test('parseAprsLine parses packet with 3-decimal minutes and missing course/speed', () {
      const packet = 'FLR1EFCCC>OGFLR,qAS,K2B9:/172500h4432.073N/07306.442W^/A=000646 !W72! id061EFCCC +039fpm';
    ...
    test('lookupDdbMultiple queries multiple IDs in a single request and returns a map', () async {
      ...
      final results = await testService.lookupDdbMultiple(['1efccc', '2abcde']);
