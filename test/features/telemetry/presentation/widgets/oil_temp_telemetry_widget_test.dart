...
void main() {
  ...
  group('OilTempTelemetryWidget Tests', () {
    ...
    testWidgets('renders normally when temperature is valid', (
      ...
      expect(
        find.byWidgetPredicate((widget) =>
            ...
            widget.painter != null &&
            widget.painter.runtimeType.toString() == '_TemperatureGaugePainter'),
        findsOneWidget,
      );
    ...
    testWidgets('enters error state (shows error icon, ---, and red border) when signal is lost (null)', (
      WidgetTester tester,
    ) async {
      SharedPreferences.setMockInitialValues({});
      await tester.pumpWidget(buildTestWidget());
