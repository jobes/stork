...
void main() {
  ...
  group('Telemetry Timeout and Null Defaults', () {
    ...
    test(
      'isGpsDroneCan becomes true with DroneCAN updates and decays to false after 5 seconds',
      () {
        fakeAsync((async) {
          final container = ProviderContainer();
          addTearDown(container.dispose);
          ...
          notifier.updateGPS(latitude: 48.0, longitude: 17.0, isDroneCan: true);
    ...
    test(
      'phone-GPS updates are suppressed for 5 seconds after DroneCAN update and allowed after timeout',
      () {
        fakeAsync((async) {
          final container = ProviderContainer();
          addTearDown(container.dispose);
