...
void main() {
  group('OpenAipEnums Localization Tests', () {
    ...
    test('AirspaceClass toLocalizedName returns correct values', () {
      ...
      expect(AirspaceClass.unclassified.toLocalizedName(l10nEn), equals('Unclassified / SUA'));
      expect(AirspaceClass.unknown.toLocalizedName(l10nEn), equals('Unknown class'));
    });

    test('AirspaceType toLocalizedName returns correct values', () {
      expect(AirspaceType.ctr.toLocalizedName(l10nEn), equals('CTR'));
      expect(AirspaceType.restricted.toLocalizedName(l10nEn), equals('Restricted'));
    ...
    test('AirspaceActivity toLocalizedName returns correct values', () {
      expect(AirspaceActivity.parachuting.toLocalizedName(l10nEn), equals('Parachuting'));
      expect(AirspaceActivity.gliding.toLocalizedName(l10nEn), equals('Gliding'));
    ...
    test('AirspaceLimit formatLimit formats flightLevel and standard units correctly', () {
    ...
    test('AirportImage formats URL endpoints correctly', () {
      ...
      expect(
        img.getFullSizeUrl('my_api_key'),
        endsWith('apiKey=my_api_key'),
      );
    });
  });
}
